    ...
    steps: {
      ...
      "1c": {
        ...
        "options": [
          ...
          { "value": "friends_gathering", "text": "친구들과 모임", "icon": "🎉", "nextStep": 2 },
          { "value": "field_trip", "text": "현장학습 단체", "icon": "🚌", "nextStep": 2 },
          { "value": "business_group", "text": "비즈니스 단체", "icon": "💼", "nextStep": 2 }
        ]
      },
      "2": {
        "id": "category",
        ...
        "options": [
          ...
          { "value": "events", "text": "행사", "icon": "🎉", "nextStep": 100, "path": "event" },
          { "value": "tourist attraction", "text": "관광지", "icon": "🏞️", "nextStep": 200, "path": "tourist" }
        ]
      },
      "3": {
        ...
        "options": [
          { "value": "value_for_money", "text": "가성비가 좋은", "icon": "💰", "nextStep": 4 },
          { "value": "guaranteed_taste", "text": "맛이 확실한", "icon": "👍", "nextStep": 4 },
          { "value": "unique_menu", "text": "특이한 메뉴가 있는", "icon": "✨", "nextStep": 4 }
        ]
      },
      "4": {
        "id": "food_type",
        ...
        "options": [
          { "value": "meal", "text": "식사", "icon": "🍚", "nextStep": 5, "subPath": "_meal" },
          { "value": "cafe", "text": "카페/디저트", "icon": "☕", "nextStep": 20, "subPath": "_cafe" },
          { "value": "pub", "text": "요리주점", "icon": "🍻", "nextStep": 30, "subPath": "_pub" }
        ]
      },
      "5": {
        "id": "meal_cuisine",
      ...
      "21": {
        "id": "cafe_consideration",
        "text": "카페의 어떤 점을 중요하게 생각하세요?",
        "options": [
          { "value": "value", "text": "가성비가 좋은", "nextStep": 22 },
          { "value": "tasty", "text": "맛이 확실한", "nextStep": 22 },
          { "value": "unique", "text": "특이한 메뉴가 있는", "nextStep": 22 }
        ]
      },
      "22": {
        "id": "cafe_atmosphere",
      ...
      "32": {
        ...
        "text": "선호하는 분위기나 특별한 기준이 있나요?",
        "options": [
          { "value": "photo_worthy", "text": "감성적이고 사진 찍기 좋은", "nextStep": 998 },
          { "value": "good_view", "text": "야외이거나 뷰가 좋은", "nextStep": 998 },
          { "value": "good_music", "text": "음악이 좋은", "nextStep": 998 },
          { "value": "private_room", "text": "룸이 있거나 프라이빗한", "nextStep": 998 }
        ]
      },
      "100": {
        "id": "event_location",
      ...
      "200": {
        ...
        "options": [
          { "value": "nature", "text": "자연 / 경관 / 힐링", "nextStep": 201, "subPath": "_nature" },
          { "value": "exhibition", "text": "전시 / 관람", "nextStep": 210, "subPath": "_exhibition" },
          { "value": "leports", "text": "레포츠 / 액티비티", "nextStep": 220, "subPath": "_leports" },
          { "value": "themepark", "text": "테마파크 / 엔터테인먼트", "nextStep": 230, "subPath": "_themepark" }
        ]
      },
      "201": {
        "id": "nature_type",
      ...
      "203": {
        ...
        "options": [
          ...
          { "value": "marine_sports", "text": "수영·서핑 등 해양 스포츠", "nextStep": 998 },
      ...
      "231": {
        ...
        "text": "어떤 종류의 장소를 찾으세요?",
        "options": [
          { "value": "themepark_amusement", "text": "테마파크 / 놀이공원", "nextStep": 998 },
